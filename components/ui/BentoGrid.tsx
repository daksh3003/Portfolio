    ...
    >
      <div className={`${id === 6} && flex justify-center h-full`}>
        ...
        <div>
          ...
          >
            <div className="font-sans font-extralight text-[#cic2d3] text-sm md:text-xs lg:text-base z-10">
              {description}
            </div>
          ...
          {id==3 && (
          <div className="flex gap-1 lg:gap-5 w-fit relative -right-4 lg:-right-2">
            <div className="flex flex-col gap-3  py-2 md:gap-3 lg:gap-8">
            {['react','typescript','nextjs'].map((item)=>(
            ...
            <div className="flex flex-col gap-3 py-2 md:gap-3 lg:gap-8">
            {['ML','Blockchain','Solidity'].map((item)=>(
